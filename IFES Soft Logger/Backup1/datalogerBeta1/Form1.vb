...
Public Class Form1
    ...
    Private Sub SerialPort2_DataReceived(ByVal sender As Object, ByVal e As System.IO.Ports.SerialDataReceivedEventArgs) Handles SerialPort2.DataReceived
        Try
            If SerialPort2.IsOpen Then
                H = SerialPort2.ReadTo("ritter_1")
                II = SerialPort2.ReadTo("ritter_2")
                J = SerialPort2.ReadTo("ritter_3")
            End If
        Catch ex As Exception
            MessageBox.Show(ex.Message.ToString)
        End Try
    ...
    Private Sub promedios_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles promedios.Tick
        ...
        If promedios.Rows.Count > 0 Then
            ...
            If flujo1.Rows.Count > 0 Then
                Dim flujot1 As Double = IIf(flujo1.Rows(0)("flujototal").ToString <> "", flujo2.Rows(0)("flujototal").ToString, 0)
    ...
    Private Sub Timer2_Tick(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Timer2.Tick
        txtflujo.Text = H / 1000
        txtFlujo2.Text = II / 1000
        txtFlujo3.Text = J / 1000
    End Sub
